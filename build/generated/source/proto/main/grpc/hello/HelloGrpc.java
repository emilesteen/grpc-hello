...
public final class HelloGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<hello.HelloOuterClass.sayHelloRequest,
      hello.HelloOuterClass.sayHelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = hello.HelloOuterClass.sayHelloRequest.class,
      responseType = hello.HelloOuterClass.sayHelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<hello.HelloOuterClass.sayHelloRequest,
      hello.HelloOuterClass.sayHelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<hello.HelloOuterClass.sayHelloRequest, hello.HelloOuterClass.sayHelloResponse> getSayHelloMethod;
      ...
      synchronized (HelloGrpc.class) {
        if ((getSayHelloMethod = HelloGrpc.getSayHelloMethod) == null) {
          HelloGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<hello.HelloOuterClass.sayHelloRequest, hello.HelloOuterClass.sayHelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hello.HelloOuterClass.sayHelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hello.HelloOuterClass.sayHelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(hello.HelloOuterClass.sayHelloRequest request,
        io.grpc.stub.StreamObserver<hello.HelloOuterClass.sayHelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                hello.HelloOuterClass.sayHelloRequest,
                hello.HelloOuterClass.sayHelloResponse>(
  ...
  public static final class HelloBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloBlockingStub> {
    ...
    /**
     */
    public hello.HelloOuterClass.sayHelloResponse sayHello(hello.HelloOuterClass.sayHelloRequest request) {
  ...
  public static final class HelloFutureStub extends io.grpc.stub.AbstractFutureStub<HelloFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<hello.HelloOuterClass.sayHelloResponse> sayHello(
        hello.HelloOuterClass.sayHelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((hello.HelloOuterClass.sayHelloRequest) request,
              (io.grpc.stub.StreamObserver<hello.HelloOuterClass.sayHelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return hello.HelloOuterClass.getDescriptor();
    }
